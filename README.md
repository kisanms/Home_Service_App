...
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| <img src="https://github.com/user-attachments/assets/15496770-84aa-446b-9c00-8363681225ff" height="600px" width="800px"> | **Select User Type**: Allows users to choose between being a customer or an employee |
